...
/**
 * Simple Word count application that defines Mapper and Reducer classes that
 * counts the words in a give input file
 */
public class WordCount {
    ...
    /**
     * Driver code to provide the mapper & reducer function classes for Hadoop Map
     * Reduce framework
     */
